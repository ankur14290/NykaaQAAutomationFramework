...
public class Z_SanitySuite_Mobile {
	...
	public void preSetupFortest() throws Throwable {
		...
		EnvironmentParameterData EnvironmentData = framework.getData(EnvironmentParameterData.class, "MsiteMan");
	...
	@Test( groups = { "sanity", "Msanity","Sanity_Live","Mcheckout","checkout","MsiteMan"})
	public void Mobile_Checkout_Flow_With_Greater_Than_500_Already_register_user()
		...
		Header_FooterBarData HeaderBar_Mobile1 = framework.getData(Header_FooterBarData.class, "shadenavigation_Mobile_Man");
		Header_FooterBarData HeaderBar_Mobile2 = framework.getData(Header_FooterBarData.class, "sizenavigation_Mobile_Man");
		CheckoutData checKoutData = framework.getData(CheckoutData.class, "valid");
		WebDriver browser = framework.getBrowser(CommonConstants.NKYAAMANMSITE);
		...
		try {
			...
			lastOrder=accountPage.getLastOrderNykaaMan();
			...
			browser.get(environmentURL);
			HeaderBar_Mobile.clearCartNykaaMan();
			...
			CartPage_Mobile.gotoHomeNykaaMan();
			boolean isSimmpleProductAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(simpleProductData);
			...
			ProductDetailData ShadeproductDetadata = ListingPage_Mobile.addAnyShadeProductFromAllProductNykaaMan();
			boolean isShadeProductAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(ShadeproductDetadata);
			...
			boolean isSizeProductAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(SizeproductDetadata);
			...
			//CheckOutPage_Mobile_New CheckOutPage_Mobile = new CheckOutPage_Mobile_New(browser);
			CheckOutPage_Mobile.checkoutWithDebitCardNykaaMan(checKoutData);
			...
			boolean isNetBanking = CheckOutPage_Mobile.netBankingCheckoutNykaaMan();
			...
			browser.get(checkouturl);
			boolean isPaytm = CheckOutPage_Mobile.PaytmWalletCheckoutNykaaMan();
			SanCS.assertTrue(isPaytm, "247");*/
		    
		    //Cod orders placemnet 
			...
			browser.get(checkouturl);
			if(!CheckOutPage_Mobile.CheckSubTotalValueGreaterThan500())
			{
				CheckOutPage_Mobile.IncreaseCartSubValueMoreThan500();
			}
			boolean cashonDelivery = CheckOutPage_Mobile.CashOnDeliveryNykaaMan();
	        SanCS.assertTrue(cashonDelivery, "L241");
			
			//checking orders in my order
			...
			boolean isOrderPresent=accountPage.orderPresentInMyOrdersNykaaMan(null,lastOrder);
	...
	@Test(groups = {"Msanity","guestMob","sanity" ,"Sanity_Live","Mcheckout","checkout","Sourabh","MsiteMan1" })
	public void Mobile_Check_end_to_end_checkout_flow_with_Guest_User() throws URISyntaxException, Throwable {
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanCS = new CustomSoftAssert(SanAssertData, browser);
		Header_FooterBarData HeaderBar_Mobile1 = framework.getData(Header_FooterBarData.class, "shadenavigation_Mobile_Man");
		Header_FooterBarData HeaderBar_Mobile2 = framework.getData(Header_FooterBarData.class, "sizenavigation_Mobile_Man");
		CheckoutData checKoutData = framework.getData(CheckoutData.class, "valid");
		...
		try {
			...
			HeaderBar_Mobile HeaderBar_Mobile = new HeaderBar_Mobile(browser);
			HeaderBar_Mobile.clearCartNykaaMan();
			//Adding shade product
			HeaderBar_Mobile.navigateToCategory(HeaderBar_Mobile1);
			ListingPage_Mobile ListingPage_Mobile = new ListingPage_Mobile(browser);
			ProductDetailData ShadeproductDetadata = ListingPage_Mobile.addAnyShadeProductFromAllProductNykaaMan();
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			CartPage_Mobile.isProductPresentInBagNykaaMan(ShadeproductDetadata);
			//adding size product
			HeaderBar_Mobile.navigateToCategory(HeaderBar_Mobile2);
			ProductDetailData SizeproductDetadata = ListingPage_Mobile.addAnySizeProductFromAllProduct();
			CheckOutPage_Mobile_New CheckOutPage_Mobile = new CheckOutPage_Mobile_New(browser);
            CartPage_Mobile.isProductPresentInBagNykaaMan(SizeproductDetadata);
			//prefroming checkout parts
			CartPage_Mobile.goToCart();
			List<ProductDetailData> Items = CheckOutPage_Mobile.FetchProductDetailNykaaMan();
			...
			String checkouturl = browser.getCurrentUrl();
			CheckOutPage_Mobile.fillNewAddressGuestNykaaMan(checKoutData);
            //checkout via debit card 
			ExtentTest childTest3 = testListener.startChild("Guest User Checkout with Debit card test");
			childTest3.setDescription(
					"This test verifies that Guest user is able to checkout with Debit card as payment method");
			TestListner.extentMap.get().put("child3", childTest3);
            CheckOutPage_Mobile.checkoutWithDebitCardNykaaMan(checKoutData);
			BankingPage_Mobile bankPage = new BankingPage_Mobile(browser);
			SanCS.assertTrue(bankPage.isPayUPage(), "L233");
			//checkout via netbanking 
	...
	@Test(groups = {"Msanity","sanity","Mcheckout","checkout","Sourabh","MsiteMan1"})
	public void Mobile_Check_end_to_end_checkout_flow_order_less_than_500() throws URISyntaxException, Throwable {
		...
		try {
			...
			ExtentTest childTest2 = testListener.startChild("Note last order ID test");
			childTest2.setDescription("This test notes the last order ID from My Orders. ");
			TestListner.extentMap.get().put("child2", childTest2);
			lastOrder=accountPage.getLastOrderNykaaMan();

			
			ExtentTest childTest3 = testListener.startChild("Simple Product add to cart Test");
			childTest3
			.setDescription("This test verifies that user is able to add simple product to cart");
			TestListner.extentMap.get().put("child3", childTest3);
			HeaderBar_Mobile HeaderBar_Mobile = new HeaderBar_Mobile(browser);
			...
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			Boolean isShadeProductAdded =CartPage_Mobile.isProductPresentInBagNykaaMan(ShadeproductDetadata);
			SanCS.assertTrue(isShadeProductAdded, "Shade Product add to cart test");
			CheckOutPage_Mobile_New CheckOutPage_Mobile = new CheckOutPage_Mobile_New(browser);
			
		/*	ExtentTest childTest4 = testListener.startChild("Apply Reward Points Test");
			childTest4.setDescription("This test verifies that user is able to apply reward points");
			TestListner.extentMap.get().put("child3", childTest4);
			...
			*/
			...
			TestListner.extentMap.get().put("child4", childTest5);
			CartPage_Mobile.gotoProccedtWithoutFreeBies();
			...
			*/
			  ...
			  //checkout via debit card 
			ExtentTest childTest4 = testListener.startChild("Checkout with help of debit card");
			childTest4.setDescription(
					"This test verifies that new user is able to do checkout through debit card when cart price is less than 500");
			TestListner.extentMap.get().put("child4", childTest4);
			CartPage_Mobile.goToCart();
			String checkouturl = browser.getCurrentUrl();
            CheckOutPage_Mobile.checkoutWithDebitCardNykaaMan(checKoutData);
			...
			SanCS.assertTrue(isNetBanking, "Net Banking Checkout");
			//checkout COD
			ExtentTest childTest6 = testListener.startChild("Checkout with help of COD");
			childTest6.setDescription(
					"This test verifies that new user is not able to do checkout through COD when cart price is less than 500");
			TestListner.extentMap.get().put("child6", childTest6);
			...
			if(CheckOutPage_Mobile.CheckSubTotalValueGreaterThan500())
			{
				childTest6.log(null, "Cart sub value is greater than 500");
				cashonDelivery= false;
			}
			else
			{
				try {
			cashonDelivery = CheckOutPage_Mobile.CashOnDeliveryNykaaMan();
			cashonDelivery= true;
				}
				catch(Exception e)
				{
			...
			SanCS.assertFalse(cashonDelivery, "COD Checkout");
	...
	@Test(groups = { "Msanity","sanity","Sanity_Live","MsiteMan1"})
	public void Mobile_Verify_user_is_Able_To_Apply_and_Remove_CouponCode() throws URISyntaxException, Throwable {
		...
		try {
			...
			ProductDetailData SizeproductDetadata = ListingPage_Mobile.addAnySizeProductFromAllProduct();
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			boolean isAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(SizeproductDetadata);
			...
			TestListner.extentMap.get().put("child3", childTest3);
			CartPage_Mobile.goToCart();
			SanCS.assertTrue(CartPage_Mobile.ApplyCouponNykaaMan(checkoutData), "150");
            //Apply Remove test code
			...
			TestListner.extentMap.get().put("child4", childTest4);
			Boolean isCanceled = CartPage_Mobile.CancelCouponNykaaMan();
			SanCS.assertTrue(isCanceled, "Remove coupon code test");
			CartPage_Mobile.checkOutNykaaMan();
		} catch (Throwable e) {
			framework.logErrorWithSnapshot(browser, e);
			Reporter.log(e.toString());
			Assert.fail();
	...
	/*@Test(groups = {"Msanity","sanity" ,"Mcheckout","checkout","MsiteMan2"})
	public void Mobile_Check_end_to_end_checkout_flow_with_guest_User_using_BhimUPI() throws Throwable {
		...
		try {
			...
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			CS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ShadeproductDetadata),
			...
			CartPage_Mobile.goToCart();
			CartPage_Mobile.gotoProccedtWithoutFreeBies();
			CheckOutPage_Mobile.fillBillingAddressNykaaMan(checkOutData);
	...
	public void Mobile_Check_end_to_end_checkout_flow_with_all_type_of_products_and_services() throws Throwable {
		...
		try {
			...
			boolean isStaticProductadded = CartPage_Mobile.isProductPresentInBagNykaaMan(staticproductDetailData);
			...
			boolean isServiceAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData);
...
*/
	 ...
	 * AccountTestCases
	 *******************************************************************************************************************************/
	@Test(groups = { "Msanity","sanity","Sanity_Live","login","Mlogin"  ,"MsiteMan1"})
	public void Mobile_Verify_User_Is_Able_To_Login_With_Google() throws Throwable, Throwable {
		...
		WebDriver browser = framwork.getBrowser("MsiteMan");
		CustomSoftAssert sanCS = new CustomSoftAssert(SanAssertData, browser);
		try {
			...
			System.out.println("excel sheet name :" + accountData.getFirstName().toLowerCase());
	...
	@Test(groups = { "Msanity","sanity" ,"Sanity_Live","Mlisting","listing","MsiteMan"})
	public void Mobile_Check_for_L1_category_page() throws Throwable {

		Header_FooterBarData HeaderBar_MobileData = framework.getData(Header_FooterBarData.class, "l1category_Mobile_Man");
		WebDriver browser = framework.getBrowser("MsiteMan");
		AccountData Login = LoginSync.getInstance().getLogin();
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		try {
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData1), "79C");
			...
			TestListner.extentMap.get().put("child2", childTest2);
			HeaderBar_Mobile.navigateToCategory(HeaderBar_MobileData);
			ProductDetailData ProductDetailData = ListingPage_Mobile.addAnyShadeProductFromAllProductNykaaMan();
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData), "79D");
...
*/
			...
			TestListner.extentMap.get().put("child8", childTest8);
            ListingPage_Mobile.LoadMoreProducts(2,false);
	...
	@Test(groups = { "Msanity","sanity","Mlisting","listing","MsiteMan"})
	public void Mobile_Check_for_L2_category_page() throws Throwable {
		Header_FooterBarData HeaderBar_MobileData = framework.getData(Header_FooterBarData.class, "sizenavigation_Mobile_Man");
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		AccountData Login = LoginSync.getInstance().getLogin();
		try {
			...
			ExtentTest childTest1 = testListener.startChild("Add any Shade/Size product from L2 category page test ");
			childTest1.setDescription("This test verifies that user is able to add any Shade/Size product from L2 category page  into cart");
			TestListner.extentMap.get().put("child1", childTest1);
			browser.get(environmentURL);
			HeaderBar_Mobile HeaderBar_Mobile = new HeaderBar_Mobile(browser);
			...
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			ProductDetailData productDetailData1 = ListingPage_Mobile.addAnySizeProductFromAllProduct();
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData1), "80C");
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData), "80D");*/
...
*/
	...
	public void Mobile_Check_for_L3_category_page() throws Throwable {
		...
		try {
...

			{
				...
				SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData1), "81C");
				...
				SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData), "81D");
	...
	public void Mobile_Check_for_Luxe_category_page() throws Throwable {
		...
		Header_FooterBarData HeaderBar_MobileData = framework.getData(Header_FooterBarData.class, "Luxe_NykaaMan_Msite");
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		AccountData Login = LoginSync.getInstance().getLogin();
		try {
...

			{
				...
				CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
				ProductDetailData ProductDetailData = ListingPage_Mobile.addAnySizeProductFromAllProduct();
				SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData), "83D");
	...
	@Test(groups = {  "Msanity","sanity","Sanity_Live","Mlisting","listing" ,"MsiteMan2"})
	public void Mobile_Check_Brand_Page() throws Throwable {

		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "brand_mobile_Man");
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		AccountData Login = LoginSync.getInstance().getLogin();
		try {
			...
			ProductDetailData productDetailData1 = ListingPage_Mobile.addAnySimpleProductFromAllProducts();
			SanAssertCS.assertTrue(cartPage.isProductPresentInBagNykaaMan(productDetailData1), "82C");
			...
			HeaderBar_Mobile.navigateToBrand(headerbarData);
			ProductDetailData ProductDetailData = ListingPage_Mobile.addAnyShadeProductFromAllProductNykaaMan();
			SanAssertCS.assertTrue(cartPage.isProductPresentInBagNykaaMan(ProductDetailData), "82D");
	...
	public void Mobile_Check_Luxe_Brand_Page() throws Throwable {
		...
		WebDriver browser = framework.getBrowser("MsiteMan");
		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "brand_mobile1_Man");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		AccountData Login = LoginSync.getInstance().getLogin();
		try {
			ExtentTest childTest = testListener.startChild("Existing User Login test");
...
/*
			...
			HeaderBar_Mobile.navigateToBrand(headerbarData);
			ProductDetailData ProductDetailData = listingPage.addAnyShadeProductFromAllProductNykaaMan();
			SanAssertCS.assertTrue(cartPage.isProductPresentInBagNykaaMan(ProductDetailData), "84D");
			...
			TestListner.extentMap.get().put("child4", childTest4);
			listingPage.LoadMoreProducts(1, false);
	...
	@Test(groups = { "Msanity","sanity","Sanity_Live","productPage", "MproductPage" ,"MsiteMan"})
	public void Mobile_simple_Product_Page_for_L1_category() throws Throwable {
		...
		try {
			...
			TestListner.extentMap.get().put("child2", childTest2);
			String checkouturl=  browser.getCurrentUrl();
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData1), "52A");
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(wishlistProductDetaildata), "52E");
	...
	@Test(groups = { "Msanity","sanity","Sanity_Live" ,"productPage", "MproductPage","Sourabh" ,"MsiteMan"})
	public void Mobile_Verify_Add_to_Bag_Shade_Product_From_Product_Page() throws Throwable {

		Header_FooterBarData HeaderBar_MobileData = framework.getData(Header_FooterBarData.class, "shadenavigation_Mobile_Man");
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		AccountData Login = LoginSync.getInstance().getLogin();
		try {
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData1), "53A");
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(wishlistProductDetaildata), "53F");
	...
	@Test(groups = { "Msanity","sanity" ,"productPage", "MproductPage" ,"MsiteMan"})
	public void Mobile_Verify_Add_to_Bag_Size_Product_From_Product_Page() throws Throwable {
		...
		try {
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(ProductDetailData1), "54A");
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(wishlistProductDetaildata), "54F");
	...
	public void Static_Combo_Add_To_Bag() throws Throwable {
		...
		try 
		{
			...
			CartPage_Mobile CartPage_Mobile = new CartPage_Mobile(browser);
			SanCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData), "55A");
			...
			SanCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailDatawishList), "55D");
	...
	@Test(groups = { "Msanity","sanity","Sanity_Live" ,"productPage", "MproductPage","Sourabh"})
	public void Mobile_Luxe_Product_Page_AddToBag() throws Throwable {
		...
		try {
			...
			SanAssertCS.assertTrue(CartPage_Mobile.isProductPresentInBagNykaaMan(productDetailData), "56A");
	...
	public void ProductPageChecks() throws Throwable, Throwable {
		...
		AccountData accountData = framework.getData(AccountData.class, "newlogin");
		WebDriver browser = framwork.getBrowser(CommonConstants.NKYAAMAN);
		CustomSoftAssert CS = new CustomSoftAssert(SanAssertData, browser);
	...
	@Test( groups = {"sanity","Msanity","Sanity_Live","Wsearch","search","Sourabh" ,"MsiteMan" })
	public void Mobile_Search_Keyword() throws Throwable, Throwable {
		Framework frameWork = new Framework();
		AccountData accountData = LoginSync.getInstance().getLogin();
		WebDriver browser = frameWork.getBrowser("MsiteMan");
		List<Header_FooterBarData> HeaderBar_MobileDataList=frameWork.getDataList(Header_FooterBarData.class, "TD4_Men");
		CustomSoftAssert CS = new CustomSoftAssert(SanAssertData, browser);
		try {
			...
			CartPage_Mobile_New CartPage_Mobile = new CartPage_Mobile_New(browser);
			ListingPage_Mobile ListingPage_Mobile= new ListingPage_Mobile(browser);
			ProductDetailData productDetadata = ListingPage_Mobile.addAnySimpleProductFromAllProducts();
			boolean isProductAdded = CartPage_Mobile.isProductPresentInBagNykaaMan(productDetadata);
	...
	@Test(groups = { "sanity","Msanity","Sanity_Live","Wsearch","search" ,"MsiteMan" })
	...
	/*@Test(groups = {"sanity","Msanity","Sanity_Live","Wsearch","search"})
	...
	@Test(groups = {"sanity","Msanity","Sanity_Live" ,"MsiteMan"})
	...
	@Test(groups = { "Msanity","sanity","filter","Mfilter","Sanity_Live","Local" ,"MsiteMan"})
	...
	@Test(groups = { "sanity","Msanity","filter","Mfilter" ,"MsiteMan"})
	public void Mobile_Brand_Filter() throws Throwable {

		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "l1category_Mobile_Man");
		WebDriver browser = framework.getBrowser("MsiteMan");
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		List<ProductDetailData> productListPriceFilter=new ArrayList<ProductDetailData>();
		List<String> printList = new ArrayList<String>();
		...
		ListingPage_Mobile listingPage = new ListingPage_Mobile(browser);
		try {
			ExtentTest childTest1 = testListener.startChild("Navigate to L1 category test ");
	...
	@Test(groups = { "sanity","Msanity","filter","Mfilter","Sanity_Live","MsiteMan"})
	...
	@Test(groups = {"sanity","Msanity","Sanity_Live","sorting","Msorting" ,"MsiteMan"})
	...
	@Test(groups = { "sanity","Msanity","cancellation","Mcancellation","Sourabh" ,"MsiteMan"})
	public void Check_end_to_end_checkout_flow_and_Item_Level_Cancellation() throws Throwable {
		Header_FooterBarData headerbar1 = framework.getData(Header_FooterBarData.class, "shadenavigation_Mobile_Man");
		Header_FooterBarData headerbar2 = framework.getData(Header_FooterBarData.class, "sizenavigation_Mobile_Man");
		AccountData Login = LoginSync.getInstance().getLogin();
		WebDriver browser = framework.getBrowser("MsiteMan");
		...
		try {
			...
			String lastOrder=accountPage.getLastOrderNykaaMan();
			...
			ListingPage_Mobile listingPage = new ListingPage_Mobile(browser);
			ProductDetailData ShadeproductDetadata = listingPage.addAnyShadeProductFromAllProductNykaaMan();
			CartPage_Mobile_New cartPage = new CartPage_Mobile_New(browser);
			...
			sanityCS.assertTrue(cartPage.isProductPresentInBagNykaaMan(SizeproductDetadata), "Add Size product to cart");
			...
			TestListner.extentMap.get().put("child6", childTest6);
			cartPage.checkOut();
			CheckOutPage_Mobile_New checkOutPage = new CheckOutPage_Mobile_New(browser);
			boolean isCashonDelivery = checkOutPage.CashOnDeliveryNykaaMan();
			...
			boolean isOrderPresent=accountPage.orderPresentInMyOrdersNykaaMan(Order_id,lastOrder);
	...
	@Test( groups = { "sanity", "Msanity","Sanity_Live","Mcheckout","checkout" ,"sabAut" ,"MsiteMan"})
