...
public class Z_SanitySuite_New {
	...
	public void preSetupFortest() throws Throwable {
		...
		String envURL = System.getProperty("URL_NM");
		if (envURL != null) {
	...
	@Test(groups = { "sanity","Wsanity","Wcheckout_NM","checkout_NM" ,"doneMan" })
	public void Checkout_Flow_With_Greater_Than_500_Already_register_user() throws URISyntaxException, Throwable {
		...
		Header_FooterBarData headerbar1 = framework.getData(Header_FooterBarData.class, "shadenavigation_Man");
		Header_FooterBarData headerbar2 = framework.getData(Header_FooterBarData.class, "sizenavigation_Man");
		Header_FooterBarData headerbar3 = framework.getData(Header_FooterBarData.class, "l2category_react_Man");
		...
		try {
			...
			lastOrder=accountPage.getLastOrder("nykaaman");
			...
			Thread.sleep(6000);
			boolean isOrderPresent=accountPage.orderPresentInMyOrders(ordersInCovertQTOCronMessage,lastOrder,CommonConstants.NKYAAMAN);
	...
	@Test(groups = { "sanity","Wsanity","react","guest","sanity_Live","Wcheckout","checkout","debug" ,"Nm_sanity_Live"})
	public void NykaaMan_Check_end_to_end_checkout_flow_with_Guest_User() throws URISyntaxException, Throwable {
		...
		try {
			...
			if(subtotal < 500)
			{
				...
				ProductDetailData SizeproductDetadata = listingPage.addSimpleProductFromAllProduct();
			...
			TestListner.extentMap.get().put("child4", childTest4);
			browser.get(checkouturl);
			boolean cashonDelivery = checkOutPage.CashOnDeliveryMan();
	...
	@Test(groups = { "Smoke", "checkout03", "rewardpoint","Wcheckout","checkout" ,"doneMan"})
	public void Check_end_to_end_checkout_flow_order_less_than_500() throws URISyntaxException, Throwable {
		...
		Header_FooterBarData headerbar1 = framework.getData(Header_FooterBarData.class, "l2category_react_Man");
		CheckoutData checKoutData = framework.getData(CheckoutData.class, "valid");
	...
	@Test(groups = { "sanity","Wsanity","sanity_Live_NM" ,"doneMan"})
	public void Verify_user_is_Able_To_Apply_and_Remove_CouponCode() throws URISyntaxException, Throwable {
		...
		try {
			...
			browser.get(environmentURL);
			AccountPage_React accountPage = new AccountPage_React(browser);
			String loggedUsername = accountPage.signInWithYourEmailMan(Login);
	...
	@Test(groups = {  "coupon", "simple", "checkout02" ,"doneMan"  })
	public void Check_end_to_end_checkout_flow_with_new_Registered_User_using_SimplePay() throws Throwable {
		...
		try {
			...
			System.out.println("shipping charges "+ shippingText );
			TestListner.testing.get().log(LogStatus.INFO,"Shipping Charge  '" + shippingText + "'");
			System.out.println("product price is : " + ShadeproductDetadata.getProductPrize());
			...
			TestListner.extentMap.get().put("child6", childTest6);
			String OTPConfirmTelephone = checkOutPage.checkoutWithSimpleMan();
	...
	public void Check_end_to_end_checkout_flow_and_Item_Level_Cancellation() throws Throwable {
		...
		try {
			...
			String lastOrder=accountPage.getLastOrder("nykaaman");
	...
	/*@Test( groups = { "ProductPageaddtobag", "Analytics", "cart01" ,"pendingDev" ,"doneMan"})
	...
	@Test(groups = { "productaddtobag", "productaddtobagstatic","AddToBag" ,"pending" ,"doneMan"})
	public void Verify_Add_to_Bag_Static_Combo_Product_From_Product_Page() throws Throwable {

		Header_FooterBarData brandNavigation = framework.getData(Header_FooterBarData.class, "combo_Man");
		WebDriver browser = framework.getBrowser(CommonConstants.NKYAAMAN);
		CustomSoftAssert SanCS = new CustomSoftAssert(SanAssertData, browser);
		browser.get(environmentURL);
	...
	@Test(groups = { "ProductPageChecks", "productpage02"  ,"doneMan"})
	public void Product_Page_Checks() throws Throwable, Throwable {
		...
		try {
			...
			TestListner.extentMap.get().put("child2", childTest2);
			browser.get(
					environmentURL + "/hair-care.html?root=nav_1&dir=desc&order=popularity");
			ProductPage productPage = new ProductPage(browser);
	...
	public void Verify_Shade_Product_Add_To_Bag_from_PDP() throws Throwable, Throwable {
		...
		Header_FooterBarData headerBarData = framework.getData(Header_FooterBarData.class, "shadenavigation_Man");
	...
	@Test(groups = { "searchFeature_NM","sanity","Wsanity" ,"Wsearch_NM","search_NM" ,"doneMan" })
	public void Auto_Suggest_Test() throws Throwable, Throwable {
		...
		// this.environmentURL = prop.getProperty("environmentName");
		List<Header_FooterBarData> NykaaManDataList = frameWork.getDataList(Header_FooterBarData.class, "TD4_Men");
		List<Header_FooterBarData> NykaaAutoSearchData = frameWork.getDataList(Header_FooterBarData.class, "TC3_Men");
		...
		try {
			ExtentTest childTest1 = testListener.startChild("Auto Suggest in Search Test for nykaa man products");
			childTest1.setDescription("This test verifies that new user is able to view auto suggest in search for nykaa man products");
			TestListner.extentMap.get().put("child1", childTest1);
			browser.get(environmentURL);
			AccountPage accountPage = new AccountPage(browser);
			accountPage.signInWithYourEmail(accountData);
			HeaderBar headerBar = new HeaderBar(browser);
			for (Header_FooterBarData headerbarData : NykaaManDataList) {
				headerBar.AutosearchResultNykaaMan(headerbarData.get_search_keyword());
				PartialStringList SearchedResult = headerBar.getValueFromAutoSuggetionList(CommonConstants.NKYAAMAN);
				CS.assertTrue(SearchedResult.contains(headerbarData.get_search_keyword().toLowerCase()), "271A");
			}
				ExtentTest childTest2 = testListener.startChild("Auto Suggest in Search Test for nykaa products");
				childTest2.setDescription("This test verifies that new user is not able to view auto suggest search for nykaa products");
				TestListner.extentMap.get().put("child2", childTest2);
				browser.get(environmentURL);
				
				for (Header_FooterBarData NykaaAutoSuggest : NykaaAutoSearchData) {
					headerBar.AutosearchResultNykaaMan(NykaaAutoSuggest.get_search_keyword());
					PartialStringList	 SearchedResult = headerBar.getValueFromAutoSuggetionList(CommonConstants.NKYAAMAN);
					CS.assertFalse(SearchedResult.contains(NykaaAutoSuggest.get_search_keyword().toLowerCase()), "271A");
			}
		}
			catch (Exception e) {
			printStackStraceinLog(e);
	...
	/*@Test(groups = { "searchFeature", "searchtrending","Wsearch","search" ,"pending"})
	public void Verify_Trending_Search() throws Throwable, Throwable {
		Framework frameWork = new Framework();
		WebDriver browser = frameWork.getBrowser(CommonConstants.NKYAAMAN);
		Header_FooterBarData Listingpage = framework.getData(Header_FooterBarData.class, "sizenavigation_Man");
		// PropertyConfiguration pf = new PropertyConfiguration();
		// Properties prop = pf.getInstance();
		// this.environmentURL = prop.getProperty("environmentName");
		...
		try {
			...
			browser.get(environmentURL);
			HeaderBar headerBar = new HeaderBar(browser);
			headerBar.navigateToCategory(Listingpage);
			ListingPage listingPage = new ListingPage(browser);
			...
			for(ProductDetailData product : productList){
				searchresultPD = headerBar.getSearchResultFromPD(product);
...
*/
	@Test( groups = {"sanity", "Wsanity","Wsearch","search" ,"doneMan"})
	public void Search_Keyword() throws Throwable, Throwable {
	   Framework frameWork = new Framework();
	   AccountData accountData = LoginSync.getInstance().getLogin();
	   WebDriver browser = frameWork.getBrowser("Web");
	   List<Header_FooterBarData> HeaderBar_List=frameWork.getDataList(Header_FooterBarData.class, "TD4_Men");
	   CustomSoftAssert CS = new CustomSoftAssert(SanAssertData, browser);
	   try {
	      ...
	      browser.get(environmentURL);
	      AccountPage_React accountPage = new AccountPage_React(browser);
	      String loggedInUserName= accountPage.signInWithYourEmailMan(accountData);
	      ...
	      for (Header_FooterBarData HeaderBar_Data : HeaderBar_List) {
	         ...
	         if(lpm.IslistingPagereactornot())
	         {
	            ...
	            if(lpm.IslistingPagereactornot()) {
	               ...
	               ProductDetailData productDetadata = lpm.addSimpleProductFromSearchedProductList();
	               ...
	               ProductDetailData productDetadata = ListingPage_M.addSimpleProductFromSearchedProductList();
	         ...
	         for(ProductDetailData  pd : productList)
	         {
	            ...
	            Boolean bol= productName.contains(search_keyword.toLowerCase())||productName.contains("flexball");
	      ...
	      HeaderBar_List=frameWork.getDataList(Header_FooterBarData.class, "TC3_Men");
	      for (Header_FooterBarData HeaderBar_Data : HeaderBar_List) {
		         String search_keyword= HeaderBar_Data.get_search_keyword();
		         ExtentTest childTest = testListener.startChild("Search with a keyword/Brand: "+search_keyword+" name test ");
		         childTest.setDescription("This test verifies that user is able to search with a keyword/Brand name: "+ search_keyword+" on page");
	...
	@Test(groups = { "homePage", "Analytics", "homepage01" ,"WSite_NM" ,"doneMan"})
	 ...
	 ***********************************************************************/
	@Test(groups = { "sanity","Wsanity","react","sanity_Live", "Local" ,"Nm_sanity_Live"})
	public void NykaaMan_React_Page_Check_for_L1_category_page() throws Throwable {

		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "l1_Man");
		...
		try {
			...
			String offerText = listingPage.verifyOfferOn(ListingPage_React.allProducts(),CommonConstants.NKYAAMAN);
	...
	@Test(groups = { "sanity","Wsanity","react_NM","Wlisting_NM","listing_NM" ,"doneMan"})
	public void React_Page_Check_for_L2_category_page() throws Throwable {

		//Header_FooterBarData headerbarDataSize = framework.getData(Header_FooterBarData.class, "sizenavigation_Man");
		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "l2_Man");
		...
		try {
			...
			ExtentTest childTest2 = testListener.startChild("Add any Simple product from L2 category React page all products section test ");
			childTest2.setDescription("This test verifies that user is able to add any Simple product from L2 category React page all products section into cart");
			TestListner.extentMap.get().put("child2", childTest2);

			ProductDetailData ProductDetailData = listingPage.addAnySimpleProductFromAllProducts();
			...
			String offerText = listingPage.verifyOfferOn(ListingPage_React.allProducts(),"nykaaman");
...
/*	@Test(groups = { "sanity","Wsanity","react","Wlisting","listing"})
	public void React_Page_Check_for_L3_category_page() throws Throwable {
		...
		try {
			...
			String offerText = listingPage.verifyOfferOn(ListingPage_React.allProducts());
...
*/
	@Test(groups = {"sanity","Wsanity","react","sorting","Wsorting" ,"doneMan"})
	...
	@Test(groups = {"sanity","Wsanity","react","sanity_Live","sorting","Wsorting" ,"Nm_sanity_Live"})
	public void NykaaMan_React_Page_Sorting_on_L2_category_page() throws Throwable {

		Header_FooterBarData headerbarData = framework.getData(Header_FooterBarData.class, "sizenavigation_Man");
		WebDriver browser = framework.getBrowser(CommonConstants.NKYAAMAN);
		CustomSoftAssert SanAssertCS = new CustomSoftAssert(SanAssertData, browser);
		List<ProductDetailData> productList = new ArrayList<ProductDetailData>();
		List<ProductDetailData> productListFromUI = new ArrayList<ProductDetailData>();
	...
	/*@Test(groups = {"sanity","Wsanity","react","sorting","Wsorting"})
...
*/
	...
	@Test(groups = { "sanity","Wsanity","react_NM","filter_NM","Wfilter_NM" ,"doneMan" })
	...
	@Test(groups = { "sanity","Wsanity","react_NM","sanity_Live_NM","filter_NM","Wfilter_NM" ,"doneMan"})
...
/*//	@Test(groups = { "sanity","Wsanity","react","filter","Wfilter"})
...
//	}
*/
	@Test(groups = { "sanity","Wsanity","react_NM","brandfilter_NM","filter_NM","Wfilter_NM" ,"doneMan" })
	...
	@Test(groups = { "sanity","Wsanity","react_NM","filter_NM","Wfilter_NM" })
	...
	/*@Test(groups = { "sanity","Wsanity","react","sanity_Live" ,"filter","Wfilter"})
...
*/
	@Test(groups = { "sanity","Wsanity" ,"react","sanity_Live","filter","Wfilter","Nm_sanity_Live"})
	public void NykaaMan_React_Page_Discount_Filter_on_L1_category_page() throws Throwable {
...
*/
	...
	@Test(groups = {"Nm_sanity_Live", "sanity","Wsanity" ,"react","sanity_Live","multipleFilter","filter","Wfilter" })
	public void NykaaMan_React_Page_Multiple_Filter_on_L2_category_page() throws Throwable {
...
*/
	 ...
	 ***********************************************************************/
	@Test(groups = { "productPage", "WproductPage","sanity","Wsanity","sanity_Live" ,"Nm_sanity_Live"})
	public void NykaaMan_React_Page_Simple_Product_Page_for_L1_category_page() throws Throwable {
	...
	@Test(groups = { "productaddtobag", "productaddtobagsimple1","sanity","Wsanity","sanity_Live","Nm_sanity_Live"})
	public void NykaaMan_React_Page_Shade_Product_Page_for_L1_category_page() throws Throwable {
...
*/
	...
	@Test(groups = { "productPage", "WproductPage","sanity","Wsanity","doneMan"})
...
*/
	...
	@Test(groups = { "Notifyme","React" ,"sabMan"})
	...
	@Test(groups = { "subscribe_NM","React_NM"})
	 ...
	 ***********************************************************************/
	   ...
	   @Test(groups = {"Wlogin","login","sanity","Wsanity","sanity_Live_NM" ,})
	public void SignUp_For_New_User() throws Throwable {
		Header_FooterBarData L1categoryReact = framework.getData(Header_FooterBarData.class, "l1_Man");
		WebDriver browser = framework.getBrowser(CommonConstants.NKYAAMAN);
		AccountData accountData = framework.getData(AccountData.class, "newlogin");
		...
		try{
			...
			browser.get(environmentURL);
			HeaderBar headerBar = new HeaderBar(browser);
			String loginUser = accountPagereact.NewRegister(accountData);
			SanCS.assertTrue((accountData.getFirstName().toLowerCase().contains(loginUser.toLowerCase().replaceAll("[^0-9]", ""))), "270");
			accountPagereact.LogOut(CommonConstants.NKYAAMAN);
	...
	@Test(groups = {"Magento_Login_NM","sanity","Wsanity","sanity_Live_NM","Wlogin_NM","login_NM"})
	...
	@Test(groups = {"Wlogin_NM","login_NM","sanity","Wsanity","sanity_Live_NM"})
	public void Login_Logout_L1_ReactPage () throws Throwable {
		...
		try{
			...
			TestListner.extentMap.get().put("child4", childTest4);
			boolean isNLogout = accountPage_react.LogOut(CommonConstants.NKYAAMAN);
			...
			TestListner.extentMap.get().put("child6", childTest6);
			boolean isGoLogout = accountPage_react.LogOut("nykaaman");
	...
	@Test(groups = {"sanity", "Wlogin","login","sanity","Wsanity" ,"sabMan"})
	...
	@Test(groups = {"sanity", "Tip_Tile","sanity","Wsanity" ,"pendingDev"})
