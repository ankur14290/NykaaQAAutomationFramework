...
public class Z_SanitySuite extends AppAction{
   ...
   TestListner testListener = new TestListner();
    ...
    @Test(retryAnalyzer = Retry.class, groups = {"Login1", "sanity","p1sanity", "local","testRun"})
    ...
    @Test(retryAnalyzer = Retry.class, groups = {"Login1", "sanity","p1sanity", "local"})
    ...
    @Test(retryAnalyzer = Retry.class, priority = 1, groups = { "Login", "sanity", "cart", "listing","p1sanity", "local"})
    public void Verify_User_Add_To_Bag_From_Listing_Page() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData newLogin = frameWork.getData(AccountData.class, "newlogin");
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "shadenavigationApp");
        Header_FooterBarDataApp headerFooterBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "sizenavigationApp");
        Header_FooterBarDataApp headerFooterBarData2 = frameWork.getData(Header_FooterBarDataApp.class, "simplenavigationApp");
    ...
    @Test(retryAnalyzer = Retry.class, priority = 1, groups = { "Login", "sanity", "cart", "checkout", "pdp","p2sanity","local"})
    ...
    @Test( priority = 1, groups = {"Login", "sanity", "pdp", "local"})
    public void Verify_Customer_Also_Bought_And_Viewed() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = LoginSync.getInstance().getLogin();
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "simplenavigationApp");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
            childTest1.setDescription("This test does login with valid username and password.");
    ...
    @Test(retryAnalyzer = Retry.class, priority = 2, groups = {"Login", "sanity", "cart", "local"})
    ...
    @Test( priority = 3, groups = {"Login", "pdp","sanity", "local"})
    public void Verify_Try_It_On_And_Notify_Me_And_Reward_Points() throws Throwable {
        ...
        Header_FooterBarDataApp headerFooterBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "browseByBrands");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Registration on Nykaa");
            childTest1.setDescription("This test verifies for registration on nykaa");
    ...
    @Test( priority = 1, groups = {"Login", "sanity", "cart","checkout", "local"})
    public void Sorting_And_Order_Value_Less_Than_500_And_Price_Calculation_And_Checkout_With_Saved_Card() throws Throwable {
        ...
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "TD1");
        Header_FooterBarDataApp headerFooterBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "shadenavigationApp");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
   ...
   //         CartPage cartPage = new CartPage(driver);
    ...
    @Test( priority = 3, groups = {"sanity", "menu", "local"})
    public void Verify_Menu_Button_Link_And_Search() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = LoginSync.getInstance().getLogin();
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "shadenavigationApp");
        Header_FooterBarDataApp header_footerBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "browseByBrands");
        Header_FooterBarDataApp headerFooterBarData2 = frameWork.getData(Header_FooterBarDataApp.class, "TD1");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
            childTest1.setDescription("This test does login with valid username and password.");
 ...
 //           customSoftAssert.assertTrue(headerBar.navigateToStyleDiva(),"TCID42");
    ...
    @Test( priority = 3, groups = {"Login", "sanity", "home", "local"})
    public void Verify_Home_Page_Link() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = LoginSync.getInstance().getLogin();
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "shadenavigationApp");
        Header_FooterBarDataApp headerFooterBarData1 = frameWork.getData(Header_FooterBarDataApp.class,"simplenavigationApp");
        Header_FooterBarDataApp headerFooterBarData2 = frameWork.getData(Header_FooterBarDataApp.class, "sizenavigationApp");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
            childTest1.setDescription("This test does login with valid username and password.");
            ...
            ExtentTest childTest3 = testListener.startChild("Check Account Section And Help Center");
            childTest3.setDescription("This test verifies if account section and help center is opening.");
            TestListner.extentMap.get().put("child3",childTest3);
    ...
    @Test(priority = 3, groups = {"sanity","production", "local"})
    public void Verify_Landing_Pages() throws Throwable {
        ...
        Header_FooterBarDataApp headerFooterBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "browseByBrands");
        Header_FooterBarDataApp headerFooterBarData2 = frameWork.getData(Header_FooterBarDataApp.class,"simplenavigationApp");
        Header_FooterBarDataApp headerFooterBarData3 = frameWork.getData(Header_FooterBarDataApp.class,"sizenavigationApp");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Registration on Nykaa");
            childTest1.setDescription("This test verifies for registration on nykaa.");
    ...
    @Test(priority = 3, groups = {"sanity", "cart", "pdp","orders", "local"})
    ...
    @Test(retryAnalyzer = Retry.class, priority = 1, groups = { "sanity", "checkout","sanity_Live", "local"})
    public void Verify_Checkout_With_Different_Methods() throws Throwable {
        ...
        Header_FooterBarDataApp navigateToShade = framework.getData(Header_FooterBarDataApp.class,"shadenavigationApp");
    ...
    @Test(priority = 3, groups = {"sanity", "rating", "pdp", "local"})
    public void Verify_Rating_And_Review_And_Subscription_And_Add_Edit_Address() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = frameWork.getData(AccountData.class , "newlogin");
        Header_FooterBarDataApp header_footerBarData = frameWork.getData(Header_FooterBarDataApp.class , "shadenavigationApp");
        Header_FooterBarDataApp header_footerBarData1 = frameWork.getData(Header_FooterBarDataApp.class , "subscription");
    ...
    @Test(priority = 3, groups = {"sanity", "listing", "filters", "local"})
    public void Verify_Filters_With_Brands_And_Discount() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = LoginSync.getInstance().getLogin();
        Header_FooterBarDataApp header_footerBarData = frameWork.getData(Header_FooterBarDataApp.class, "sizenavigationApp");
        Header_FooterBarDataApp header_footerBarData1 = frameWork.getData(Header_FooterBarDataApp.class, "simplenavigationApp");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
            childTest1.setDescription("This test does login with valid username and password.");
    ...
    @Test(retryAnalyzer = Retry.class, groups = { "Login1", "local"})
    ...
    @Test( priority = 2, groups = {"Login", "local"})
    public void Notify_Me_For_All_Type_of_Product() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = LoginSync.getInstance().getLogin();
        Header_FooterBarDataApp headerFooterBarData = frameWork.getData(Header_FooterBarDataApp.class, "browseByBrands");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
            childTest1.setDescription("This test does login with valid username and password.");
    ...
    @Test( priority = 2, groups = {"Login", "cart", "local"})
    ...
    @Test(priority = 2, groups = {"orders", "local"})
    ...
    public void Verify_Checkout_With_Saved_Card() throws Throwable {
        ...
        Header_FooterBarDataApp header_footerBarData = frameWork.getData(Header_FooterBarDataApp.class , "simplenavigationApp");
        CheckoutData checkoutData = frameWork.getData(CheckoutData.class,"valid");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Login in Nykaa");
    ...
    @Test( priority = 2, groups = { "checkout", "cart", "local"})
    ...
    @Test(priority = 3, groups = { "subscription", "pdp", "local"})
    public void Verify_Subscription_Of_Product() throws Throwable {
        Framework frameWork = new Framework();
        AndroidDriver driver = frameWork.getAndroidDriver();
        AccountData Login = frameWork.getData(AccountData.class , "newlogin");
        Header_FooterBarDataApp header_footerBarData = frameWork.getData(Header_FooterBarDataApp.class , "subscription");
        CheckoutData checkoutData = frameWork.getData(CheckoutData.class,"valid");
        CustomSoftAssert customSoftAssert = new CustomSoftAssert(SanAssertData, driver);
        try {
            ExtentTest childTest1 = testListener.startChild("Registration on Nykaa");
    ...
    @Test(priority = 1, groups = { "checkout", "local"})
